...
// import EmblemasItems from '../data/EmblemasItens';
     ...
     <div className='flex flex-col items-center w-[1510px]'>
       <div className='relative flex flex-col items-center mb-8'>
         ...
         <div className='text-center mt-4'>
           <h1 className='text-xl font-bold'>Tiago</h1>
           <p className='text-base'><strong>Matrícula:</strong> 201901004</p>
           <p className='text-base'><strong>Turma:</strong> A4</p>
         </div>
       </div>
       ...
       <div className='w-full max-w-9xl bg-white mb-5 border-2 border-[#707070] flex text-center'>
         ...
         <p className='py-4 w-1/3'>Nível no Forum: INICIANTE</p>
