...
export function Home() {
  ...
  return (
    <div>
      ...
      <h1 className='text-center text-3xl italic font-bold'>MENU PRINCIPAL</h1>      
      ...
      <div>
        ...
        {showNoCodeMessage && (
          <div className='fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center'>
            <div className='absolute text-center left-1/2 transform -translate-x-1/2 w-[600px] h-auto bg-white shadow-lg z-50 text-black'>
                <img src={megaphone} alt='megaphone' className='h-[100px] mx-auto my-4' />
        ...
        {showInvalidCodeMessage && (
          <div className='fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center'>
            <div className='absolute left-1/2 transform -translate-x-1/2 w-[600px] h-auto bg-white shadow-lg z-50 text-black text-center'>
                <img src={megaphone} alt='megaphone' className='h-[100px] mx-auto my-4' />
                <strong className='text-xl text-red-600 '>
